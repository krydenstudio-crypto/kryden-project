...
const HomeBanner = () => {
  return (
    <section className='lg:py-24 flex flex-col justify-center items-center px-2 py-18'>
      <div className='relative lg:w-[60%] w-full'>
        ...
        {/**Banner text***/}
        <div className='lg:pt-10 pt-5 lg:px-4 w-full'>
          <h1 className='lg:text-5xl text-3xl font-bold text-textFocus text-center lg:leading-18 leading-10 px-10 mb-3'>
      ...
      <div className="flex justify-between">
        <img src="/Rectangle 3.png" alt="Rectangle" />
        <img src="/Rectangle 4.png" alt="Rectangle" />
      </div>
      </div>
    </section>
  )
